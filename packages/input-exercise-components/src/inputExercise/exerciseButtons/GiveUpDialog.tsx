...
export function GiveUpDialog({ open, disabled, onConfirm, onCancel }: GiveUpDialogProps) {
	return <Dialog open={open} onClose={onCancel} maxWidth="sm" fullWidth>
		...
		<DialogActions>
			...
			<Button disabled={disabled} onClick={onConfirm} color="warning" variant="contained" startIcon={<Flag />}>
				Give Up
			</Button>
		</DialogActions>
	</Dialog>
